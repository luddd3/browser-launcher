...
function createFirefox (name, configDir, cb) {
    ...
    var profile = profileName + ' ' + configDir + '/firefox-profiles'
    var args = [ '-no-remote', '-CreateProfile', profile ];
    ...
    ps.on('exit', function (code) {
        ...
        else cb(null, { name : profileName, file : configDir + '/firefox-profiles/' + profileName })
    });
}
